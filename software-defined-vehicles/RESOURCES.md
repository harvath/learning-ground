...
- [Tesla Inc. Form 10-Q, Q3 2019 — SEC EDGAR](https://www.sec.gov/Archives/edgar/data/1318605/000156459019038256/tsla-10q_20190930.htm)
  Primary filing: deferred revenue grew from $630M (Dec 31, 2018) to $1.045B (Sept 30, 2019), including Supercharger access, connectivity, and Autopilot/FSD features not yet fully delivered. **Use for**: proof that software-as-recurring-revenue was a real, audited balance-sheet item, not just marketing. Use the `.htm` filing, not the `Financial_Report.xlsx` attachment — the latter isn't fetchable as readable text.
- [Tesla, Inc. (TSLA) Q3 2019 Earnings Call Transcript — The Motley Fool](https://www.fool.com/earnings/call-transcripts/2019/10/24/tesla-inc-tsla-q3-2019-earnings-call-transcript.aspx)
  CFO Zach Kirkhorn, in his own words: "with the release of Smart Summon in the US, we were able to recognize $30 million of deferred revenue," plus ~$500–600M in unrecognized FSD-related deferred revenue at the time. **Use for**: the clearest concrete example of the OTA-update-to-recognized-revenue mechanic, used in A3.
- [US government opens investigation into Tesla Autopilot crashes with emergency vehicles — S&P Global Mobility](https://autotechinsight.spglobal.com/news/5262111/us-government-opens-investigation-into-tesla-autopilot-crashes-with-emergency-vehicles) (Aug 2021)
- [US asks Tesla why it didn't recall Autopilot driving system — MarketBeat wire report](https://www.marketbeat.com/articles/us-asks-tesla-why-it-didnt-recall-autopilot-driving-system-2021-10-13/) (Oct 13, 2021)
  **Use for**: the NHTSA OTA-vs-recall-law collision in A3 — CNBC and TechCrunch also covered this same episode on the same date if either of the above goes stale.
...
- [InsideEVs — How Rivian Developed Its Zonal Architecture In Just Two Years](https://insideevs.com/news/761865/rivian-zonal-architecture-development/) and [Popular Science — How Rivian reduced electrical wiring by 1.6 miles and 44 pounds](https://www.popsci.com/technology/rivian-zonal-electrical-architecture/)
  Rivian Gen 1 (17 control units) → Gen 2 (7 units — 5 still dedicated: infotainment, autonomy, vehicle access, drive units, battery management; everything else on 3 shared zonal computers), −1.6 miles of wiring / −44 lbs, per SVP Vidya Rajagopalan. **Use for**: the clearest concrete, named-executive zonal-migration case study, used in A4.
